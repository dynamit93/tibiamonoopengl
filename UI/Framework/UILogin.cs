...
namespace tibiamonoopengl.UI.Framework
{
    public class LoginWindow 
    {
        ...
        public LoginWindow(Texture2D backgroundTexture, SpriteBatch spriteBatch, GraphicsDevice graphicsDevice, string serverAddress, int serverPort, ClientViewport clientViewport, GameDesktop gameDesktop)
        {
            ...
            networkManager = new NetworkManager(clientViewport,this, gameDesktop);
